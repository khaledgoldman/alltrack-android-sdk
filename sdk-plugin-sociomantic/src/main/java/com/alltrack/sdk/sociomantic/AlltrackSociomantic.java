package com.alltrack.sdk.sociomantic;
...
public abstract class AlltrackSociomantic {
    ...
    public static void injectCustomerDataIntoEvent(AlltrackEvent event, Map<String, String> customerData) {
        if (null == event) {
    ...
    public static void injectHomePageIntoEvent(AlltrackEvent event) {
        if (null == event) {
            logger.error("Event object is required.");
        }
    ...
    public static void injectViewListingIntoEvent(AlltrackEvent event, List<String> categories) {
        injectViewListingIntoEvent(event, categories, null);
    }
    public static void injectViewListingIntoEvent(AlltrackEvent event, List<String> categories, String date) {
        if (null == event) {
            logger.error("Event object is required.");
            return;
        }
    ...
    public static void injectProductIntoEvent(AlltrackEvent event, String productId) {
        injectProductIntoEvent(event, productId, null);
    }
    public static void injectProductIntoEvent(AlltrackEvent event, String productId, Map<String, Object> parameters) {
        if (null == event) {
            logger.error("Event object is required.");
            return;
        }
    ...
    public static void injectCartIntoEvent(AlltrackEvent event, List products) {
        if (null == event) {
            logger.error("Event object is required.");
            return;
        }
    ...
    public static void injectConfirmedTransactionIntoEvent(AlltrackEvent event, String transactionID, List products) {
        injectTransactionIntoEvent(event, transactionID, products, null, Boolean.TRUE);
    }
    public static void injectConfirmedTransactionIntoEvent(AlltrackEvent event, String transactionID, List products, Map<String, Object> parameters) {
        injectTransactionIntoEvent(event, transactionID, products, parameters, Boolean.TRUE);
    }

    public static void injectTransactionIntoEvent(AlltrackEvent event, String transactionID, List products) {
        injectTransactionIntoEvent(event, transactionID, products, null, Boolean.FALSE);
    }
    public static void injectTransactionIntoEvent(AlltrackEvent event, String transactionID, List products, Map<String, Object> parameters) {
        injectTransactionIntoEvent(event, transactionID, products, parameters, Boolean.FALSE);
    }
    private static void injectTransactionIntoEvent(AlltrackEvent event, String transactionID, List products, Map<String, Object> parameters, Boolean confirmed) {
        if (null == event) {
            logger.error("Event object is required.");
            return;
        }
    ...
    public static void injectLeadIntoEvent(AlltrackEvent event, String leadID) {
        injectLeadIntoEvent(event, leadID, Boolean.FALSE);
    }
    public static void injectLeadIntoEvent(AlltrackEvent event, String leadID, Boolean confirmed) {
    ...
    private static void addPartnerParameter(AlltrackEvent event) {
        addPartnerParameter(event, null, null);
    }
    private static void addPartnerParameter(AlltrackEvent event, String parameter, String json) {
        if (null == adpanId) {
