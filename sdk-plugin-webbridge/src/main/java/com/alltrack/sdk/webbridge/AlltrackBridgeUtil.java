 ...
 */
public class AlltrackBridgeUtil {
    public static void sendDeeplinkToWebView(final WebView webView, final Uri deeplink) {
        // If web view is initialised, trigger alltrack_deeplink method which user should override.
        // In this method, the content of the deeplink will be delivered.
        if (webView != null) {
            webView.post(new Runnable() {
                @Override
                public void run() {
                    String command = "javascript:alltrack_deeplink('" + deeplink.toString() + "');";
    ...
    public static void execAttributionCallbackCommand(final WebView webView, final String commandName, final AlltrackAttribution attribution) {
        if (webView == null) {
            return;
        }
        if (attribution == null) {
    ...
    public static void execSessionSuccessCallbackCommand(final WebView webView, final String commandName, final AlltrackSessionSuccess sessionSuccess) {
        if (webView == null) {
            return;
        }
    ...
    public static void execSessionFailureCallbackCommand(final WebView webView, final String commandName, final AlltrackSessionFailure sessionFailure) {
        if (webView == null) {
            return;
        }
    ...
    public static void execEventSuccessCallbackCommand(final WebView webView, final String commandName, final AlltrackEventSuccess eventSuccess) {
        if (webView == null) {
            return;
        }
    ...
    public static void execEventFailureCallbackCommand(final WebView webView, final String commandName, final AlltrackEventFailure eventFailure) {
        if (webView == null) {
            return;
        }
