...
public class SingleThreadCachedScheduler implements ThreadScheduler {
        ...
        threadPoolExecutor = new ThreadPoolExecutor(
            ...
            new RejectedExecutionHandler() {     // Logs rejected runnables rejected from the entering the pool
                ...
                public void rejectedExecution(Runnable runnable, ThreadPoolExecutor executor) {
                    AlltrackFactory.getLogger().warn("Runnable [%s] rejected from [%s] ",
            ...
            threadPoolExecutor.submit(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        AlltrackFactory.getLogger().warn("Sleep delay exception: %s",
                                e.getMessage());
                    }
    ...
    private void tryExecuteRunnable(Runnable runnable) {
        try {
            ...
            AlltrackFactory.getLogger().warn("Execution failed: %s", t.getMessage());
        }
    }
