...
import com.alltrack.sdk.TrackingState;
import com.alltrack.sdk.Util;
import com.alltrack.sdk.scheduler.SingleThreadCachedScheduler;
import com.alltrack.sdk.scheduler.ThreadExecutor;
import com.alltrack.sdk.network.UtilNetworking.IHttpsURLConnectionProvider;
import com.alltrack.sdk.network.UtilNetworking.IConnectionOptions;
...
public class ActivityPackageSender implements IActivityPackageSender {
    ...
    public ActivityPackageSender(final String alltrackUrlStrategy,
                                 ...
                                 final String clientSdk)
    {
        ...
        urlStrategy = new UrlStrategy(
                AlltrackFactory.getBaseUrl(),
                AlltrackFactory.getGdprUrl(),
                AlltrackFactory.getSubscriptionUrl(),
                alltrackUrlStrategy);

        httpsURLConnectionProvider = AlltrackFactory.getHttpsURLConnectionProvider();

        connectionOptions = AlltrackFactory.getConnectionOptions();
    }
    ...
    private void parseResponse(final ResponseData responseData, final String responseString) {
        ...
        responseData.attribution = AlltrackAttribution.fromJson(
                attributionJson,
                responseData.adid,
                                              ...
                                              final String nativeVersion)
    {
        ...
        String algorithmHeader = Util.formatString("algorithm=\"%s\"", algorithm != null ? algorithm : "alt1");
