...
public class SharedPreferencesManager {
    /**
     * Name of Alltrack preferences.
     */
    private static final String PREFS_NAME = "alltrack_preferences";
    ...
    private SharedPreferencesManager(final Context context) {
        try {
            ...
            AlltrackFactory.getLogger().error("Cannot access to SharedPreferences", exception.getMessage());
