...
import static com.alltrack.sdk.Constants.HIGH;
import static com.alltrack.sdk.Constants.LARGE;
import static com.alltrack.sdk.Constants.LONG;
import static com.alltrack.sdk.Constants.LOW;
import static com.alltrack.sdk.Constants.MEDIUM;
import static com.alltrack.sdk.Constants.NORMAL;
import static com.alltrack.sdk.Constants.SMALL;
import static com.alltrack.sdk.Constants.XLARGE;
...
class DeviceInfo {
    ...
    void reloadPlayIds(final AlltrackConfig alltrackConfig) {
        if (!Util.canReadPlayIds(alltrackConfig)) {
            return;
        }

        Context context = alltrackConfig.context;
    ...
    void reloadNonPlayIds(final AlltrackConfig alltrackConfig) {
        ...
        androidId = Util.getAndroidId(alltrackConfig.context);
