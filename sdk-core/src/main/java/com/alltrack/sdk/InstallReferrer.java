...
import static com.alltrack.sdk.Constants.ONE_SECOND;
...
public class InstallReferrer implements InvocationHandler {
    ...
    private Object createInstallReferrer(Context context, InstallReferrerReadListener referrerCallback, ILogger logger) {
        return Reflection.createInstance("com.alltrack.sdk.play.InstallReferrer",
    ...
    public void startConnection() {
        ...
        if (!AlltrackFactory.getTryInstallReferrer()) {
            return;
        }
        closeReferrerClient();
