...
import static com.alltrack.sdk.Constants.ALLTRACK_PREINSTALL_CONTENT_PROVIDER_INTENT_ACTION;
import static com.alltrack.sdk.Constants.ALLTRACK_PREINSTALL_SYSTEM_PROPERTY_PATH;
import static com.alltrack.sdk.Constants.ALLTRACK_PREINSTALL_SYSTEM_PROPERTY_PREFIX;
import static com.alltrack.sdk.Constants.ALLTRACK_PREINSTALL_FILE_SYSTEM_PATH;
import static com.alltrack.sdk.Constants.ALLTRACK_PREINSTALL_CONTENT_URI_AUTHORITY;
import static com.alltrack.sdk.Constants.ALLTRACK_PREINSTALL_CONTENT_URI_PATH;
...
public class PreinstallUtil {
                                                      ...
                                                      final ILogger logger)
    {
        return readSystemProperty(
                ALLTRACK_PREINSTALL_SYSTEM_PROPERTY_PREFIX + packageName, logger);
    }
    ...
    public static String getPayloadFromSystemPropertyFilePath(final String packageName,
                                                              final ILogger logger)
    {
        String filePath = readSystemProperty(ALLTRACK_PREINSTALL_SYSTEM_PROPERTY_PATH, logger);
    ...
    public static String getPayloadFromSystemPropertyFilePathReflection(final String packageName,
                                                                        final ILogger logger)
    {
        String filePath = readSystemPropertyReflection(ALLTRACK_PREINSTALL_SYSTEM_PROPERTY_PATH, logger);
    ...
    public static String getPayloadFromContentProviderDefault(final Context context,
                                                              ...
                                                              final ILogger logger)
    {
        if (!Util.resolveContentProvider(context, ALLTRACK_PREINSTALL_CONTENT_URI_AUTHORITY)) {
            return null;
        }

        String defaultContentUri = Util.formatString("content://%s/%s",
                ALLTRACK_PREINSTALL_CONTENT_URI_AUTHORITY, ALLTRACK_PREINSTALL_CONTENT_URI_PATH);
    ...
    public static String getPayloadFromFileSystem(final String packageName,
                                                  ...
                                                  final ILogger logger)
    {
        String content = readFileContent(ALLTRACK_PREINSTALL_FILE_SYSTEM_PATH, logger);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU) {
            providers = context.getPackageManager()
              .queryIntentContentProviders(
                new Intent(ALLTRACK_PREINSTALL_CONTENT_PROVIDER_INTENT_ACTION),
                PackageManager.ResolveInfoFlags.of(0));
        } else {
            providers = context.getPackageManager()
              .queryIntentContentProviders(
                new Intent(ALLTRACK_PREINSTALL_CONTENT_PROVIDER_INTENT_ACTION), 0);
        }
            ...
            if (permissionGranted) {
                ...
                if (authority != null && !authority.isEmpty()) {
                    String contentUri = Util.formatString("content://%s/%s",
                                                          authority, ALLTRACK_PREINSTALL_CONTENT_URI_PATH);
