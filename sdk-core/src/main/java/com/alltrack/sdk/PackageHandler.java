...
import com.alltrack.sdk.scheduler.ThreadScheduler;
...
import static com.alltrack.sdk.Constants.CALLBACK_PARAMETERS;
import static com.alltrack.sdk.Constants.PARTNER_PARAMETERS;

// persistent
public class PackageHandler implements IPackageHandler,
        IActivityPackageSender.ResponseDataCallbackSubscriber
{
    private static final String PACKAGE_QUEUE_FILENAME = "AlltrackIoPackageQueue";
                          ...
                          IActivityPackageSender packageHandlerActivityPackageSender)
    {
        ...
        this.logger = AlltrackFactory.getLogger();
        this.backoffStrategy = AlltrackFactory.getPackageHandlerBackoffStrategy();
        this.backoffStrategyForInstallSession = AlltrackFactory.getInstallSessionBackoffStrategy();
