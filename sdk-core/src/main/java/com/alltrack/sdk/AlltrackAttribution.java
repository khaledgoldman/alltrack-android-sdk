 ...
 */
public class AlltrackAttribution implements Serializable {
    ...
    public static AlltrackAttribution fromJson(JSONObject jsonObject, String adid, String sdkPlatform) {
        if (jsonObject == null) return null;

        AlltrackAttribution attribution = new AlltrackAttribution();
    ...
    public boolean equals(Object other) {
        ...
        AlltrackAttribution otherAttribution = (AlltrackAttribution) other;
