...
public class AlltrackSigner {
    ...
    private static void getSignerInstance() {
        if (signerInstance == null) {
            synchronized (AlltrackSigner.class) {
                if (signerInstance == null) {
                    signerInstance = Reflection.createDefaultInstance("com.alltrack.sdk.sig.Signer");
                }
            }
        }
    }
