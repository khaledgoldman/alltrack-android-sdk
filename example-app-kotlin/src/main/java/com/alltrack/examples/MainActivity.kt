...
class MainActivity : AppCompatActivity() {
    ...
    fun onTrackSimpleEventClick(v: View) {
        val event = AlltrackEvent(EVENT_TOKEN_SIMPLE)
    ...
    fun onTrackRevenueEventClick(v: View) {
        val event = AlltrackEvent(EVENT_TOKEN_REVENUE)
    ...
    fun onTrackCallbackEventClick(v: View) {
        val event = AlltrackEvent(EVENT_TOKEN_CALLBACK)
    ...
    fun onTrackPartnerEventClick(v: View) {
        val event = AlltrackEvent(EVENT_TOKEN_PARTNER)
