package com.alltrack.sdk.oaid;

import android.content.Context;
import android.util.Log;

import com.alltrack.sdk.ILogger;
import com.alltrack.sdk.PackageBuilder;
...
public class Util {
    public synchronized static Map<String, String> getOaidParameters(Context context, ILogger logger) {
        if (!AlltrackOaid.isOaidToBeRead) {
            return null;
        }
    ...
    private static Map<String, String> getOaidParametersUsingMsa(Context context, ILogger logger) {
        if (!AlltrackOaid.isMsaSdkAvailable) {
            return null;
        }
    ...
    public static String readCertFromAssetFile(Context context) {
        try {
            ...
            Log.e("Alltrack", "readCertFromAssetFile failed");
            return "";
        }
    }
}
