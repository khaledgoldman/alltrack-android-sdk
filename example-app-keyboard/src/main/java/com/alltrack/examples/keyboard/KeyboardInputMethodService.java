package com.alltrack.examples.keyboard;
...
public class KeyboardInputMethodService extends InputMethodService implements KeyboardView.OnKeyboardActionListener {
    ...
    public void onWindowShown() {
        ...
        // notify Alltrack sdk to resume on keyboard open
        Alltrack.onResume();
    }
    ...
    public void onWindowHidden() {
        ...
        // notify Alltrack sdk to pause on keyboard close
        Alltrack.onPause();
    }
    ...
    public void onTrackSimpleEventClick() {
        AlltrackEvent event = new AlltrackEvent("g3mfiw");
