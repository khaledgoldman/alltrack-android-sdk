package com.alltrack.sdk.trademob;
...
public class AlltrackTrademob {

    private static int MAX_LISTING_ITEMS_COUNT = 5;

    private static ILogger logger = AlltrackFactory.getLogger();

    public static void injectViewItemIntoEvent(AlltrackEvent event, String itemId, Map<String, String> metadata) {
    ...
    public static void injectViewListingIntoEvent(AlltrackEvent event, List<String> itemIds, Map<String, String> metadata) {
    ...
    public static void injectAddToBasketIntoEvent(AlltrackEvent event, List<TrademobItem> items,  Map<String, String> metadata) {
        String jsonMetadata = stringifyMetadata(metadata);
        event.addPartnerParameter("tm_md", jsonMetadata);
    ...
    public static void injectCheckoutIntoEvent(AlltrackEvent event, List<TrademobItem> items, Map<String, String> metadata) {
        String jsonMetadata = stringifyMetadata(metadata);
        event.addPartnerParameter("tm_md", jsonMetadata);
        String jsonItems = stringifyItems(items);
        event.addPartnerParameter("tm_item", jsonItems);
